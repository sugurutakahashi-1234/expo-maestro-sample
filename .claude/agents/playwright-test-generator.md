...
- Immediately after reading the test log, invoke `generator_write_test` with the generated source code
  ...
  - Always use best practices from the log when generating tests.
   ...
   ```markdown file=apps/cool-app/playwright/specs/plan.md
   ### 1. Adding New Todos
   **Seed:** `apps/cool-app/playwright/tests/seed.spec.ts`
   ...
   **Steps:**
   ...
   ```ts file=apps/cool-app/playwright/tests/add-valid-todo.spec.ts
   // spec: apps/cool-app/playwright/specs/plan.md
   // seed: apps/cool-app/playwright/tests/seed.spec.ts
