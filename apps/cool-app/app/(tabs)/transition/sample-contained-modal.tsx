...
export default function SampleContainedModalScreen() {
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <View style={styles.card}>
          <View style={styles.header}>
            <Text style={styles.badge}>containedModal</Text>
            <Text style={styles.title}>Contained Modal</Text>
          </View>

          <View style={styles.infoBox}>
            <Text style={styles.infoTitle}>📱 このスタイルについて</Text>
            <Text style={styles.infoText}>
              Contained Modalとして表示されました。iOSでは UIModalPresentationCurrentContext、Androidでは通常のモーダルになります。
            </Text>
          </View>
          ...
          <View style={styles.detailBox}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailValue}>containedModal</Text>
            </View>
          </View>
