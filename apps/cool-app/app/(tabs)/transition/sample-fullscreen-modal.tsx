...
export default function SampleFullScreenModalScreen() {
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <View style={styles.card}>
          <View style={styles.header}>
            <Text style={styles.badge}>fullScreenModal</Text>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Full Screen Modalとして表示されました。iOSでは UIModalPresentationFullScreen、Androidでは通常のモーダルになります。
            </Text>
          </View>
          ...
          <View style={styles.detailBox}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailValue}>fullScreenModal</Text>
            </View>
          </View>
